<!-- ============================================================ 
 Formulaire pour modifier une classe pour une école
 - les informations sur les classes
 - Lié à la page modifierF.php
 (c) 2024 SPELLANZON Nelly

 Back end :
 - Programmation liste déroulante classes
...
$classes = getClassesParEcole($id_utilisateur, $erreur);
...
@$valider_classe = $_POST["valider_modifier_classe"];

modifierClasse($erreur, $message, $valider_classe, $id_utilisateur);

?>

<form name="modifierClasseEcole" method="post" action="ficheInformation.php#modifierClasseEcole">
    <ul>
        <h2> Modification de classes </h2>
        ...
        <li>
            <label for="classe">Choisissez la classe à modifié&nbsp;:</label>
            <select name="Id_classe" id="classe">
                <option value="">--Choisissez une classe de votre choix--</option>
        ...
        <li>
            ...
            <select name="niveau_scolarite" id="idniveau_scolarite">
                <option value="">--Choisissez le niveau scolaire--</option>
        ...
        <li id="professeurSection">
            ...
            <div id="professeur1" class="professeur">
                ...
                <input type="text" name="professeur_nom1" class="professeur_nom"
                    value="<?php echo $professeur_nom1 ?>" />
            </div>

            <!-- Champs pour le deuxième professeur -->
            <div id="professeur2" class="professeur">
                ...
                <input type="text" name="professeur_nom2" class="professeur_nom"
                    value="<?php echo $professeur_nom2 ?>" />
            </div>
        </li>

        <li>
            <label for="effectif">Effectif de la classe&nbsp;:</label>
            <input type="int" id="idclasse_effectif" name="classe_effectif" />
        </li>
        <li>
    ...
    <div class="button">
        <button type="submit" name="valider_modifier_classe">Valider</button>
    </div>
</form>
